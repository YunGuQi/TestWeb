            ...
            <AnimatePresence>
              {history.length > 0 && (
                <motion.button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 bg-white/5 border border-white/10 backdrop-blur-md text-zinc-300 text-sm font-medium py-3 rounded-xl hover:bg-white/10 active:scale-95 transition-all"
                >
