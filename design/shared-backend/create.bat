@echo off
npx -y -p @cloudbase/cli tcb db nosql execute -e test-backend-d8grj1s21652da209 --command "[{\"TableName\":\"TestProject\",\"CommandType\":\"INSERT\",\"Command\":\"{\\\"insert\\\":\\\"TestProject\\\",\\\"documents\\\":[{\\\"_id\\\":\\\"dummy\\\"}]}\"}]"
